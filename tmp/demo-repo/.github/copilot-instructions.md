...
Append-only policy:
- Do not rewrite old log history in `03_actions.md` or `05_handoffs.log`.
- Add corrections as new entries referencing prior IDs.
- Add blockers to `04_blockers.md` with status tags.
...
- Generated catalog location: `.github/agentic_brain/catalog/awesome-catalog.json`.
- Curated required set location: `.github/agentic_brain/catalog/required-assets.json`.
