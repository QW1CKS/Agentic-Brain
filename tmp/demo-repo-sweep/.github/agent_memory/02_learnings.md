...
- Append action entries after meaningful work so the ledger stays current.
...
- **ID:** LEA-YYYYMMDD-XXX
- **Date:** <YYYY-MM-DD>
- **Learning:** <reusable pattern or caution>
- **Source:** <task/incident reference>
- **Validation:** <how validated>
- **Related:** <links to decisions/actions>
